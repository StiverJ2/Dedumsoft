            ...
            function openCambiarEstado(row) {
                ...
                DsCrud.openModal({
                    ...
                    onSave: function (m) {
                        ...
                        DsCrud.api('../api/artesano_ordenes.php', 'PUT', payload, function () {
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4) {
                        if (xhr.status >= 200 && xhr.status < 300) {
                            ...
                            var msg = 'Error';
                            try {
                                msg = JSON.parse(xhr.responseText).MENSAJE || msg;
                            } catch (e) { }
                            onError(msg);
                        }
                    }
            ...
            function handleTableClick(e) {
                ...
                if (action === 'estado') {
                    ...
                    openLegacyModal('Cambiar estado - Orden #' + ordenId, body, function (overlay, close) {
                        ...
                        data.id = ordenId;
                        apiPut('../api/artesano_ordenes.php', data, function () {
                    ...
                    openLegacyModal('Registrar consumo - Orden #' + ordenId, body, function (overlay, close) {
                        ...
                        apiPost('../api/artesano_consumo.php', data, function () {
                    ...
                    openLegacyModal('Pieza terminada - Orden #' + ordenId, body, function (overlay, close) {
                        ...
                        apiPost('../api/artesano_terminada.php', data, function () {
