...
INSERT INTO tipos_maquinaria (codigo, nombre, descripcion) VALUES
    ('FUNDICION', 'Fundición', 'Equipos para fundición de metales'),
    ('CORTE', 'Corte', 'Máquinas de corte y precisión'),
    ('PULIDO', 'Pulido', 'Equipos de pulido y acabado'),
    ('SOLDADURA', 'Soldadura', 'Equipos de soldadura'),
    ('GRABADO', 'Grabado', 'Máquinas de grabado y marcado'),
    ('LAMINADO', 'Laminado', 'Equipos de laminación'),
    ('LIMPIEZA', 'Limpieza', 'Equipos de limpieza ultrasónica y química'),
    ('MEDICION', 'Medición', 'Instrumentos de medición y pesaje'),
...
-- Primero insertar tipos únicos que no existan
...
-- 5. Actualizar tipo_maquinaria_id basado en el texto tipo existente
