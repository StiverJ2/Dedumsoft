 ...
 * @var string $chart_params
 * @var array  $rep_produccion
 * @var array  $rep_inventario
 * @var array  $rep_eficiencia
 * @var array  $rep_materiales
 * @var array  $rep_ventas
 * @var array  $rep_compras
 * @var array  $rep_usuarios
 * @var bool   $legacy
 */
?>
<div class="content">
    ...
    <div class="card">
        ...
        <?php endif; ?>
            <div>
                ...
                <input type="<?php echo $input_type; ?>" id="desde" name="desde" class="form-control form-control-sm ds-field" value="<?php echo v_e($desde); ?>">
            </div>
            <div>
                <label class="form-label muted" for="hasta">Hasta</label>
                <input type="<?php echo $input_type; ?>" id="hasta" name="hasta" class="form-control form-control-sm ds-field" value="<?php echo v_e($hasta); ?>">
            </div>
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_produccion as $row): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo v_e((string)$row['producto']); ?></td>
                            <td><?php echo v_e((string)$row['cantidad']); ?></td>
                            <td><?php echo v_e((string)($row['artesano'] ?? '')); ?></td>
                            <td><?php echo v_e($estado_label); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_inventario as $row): ?>
                        <tr>
                            <td><?php echo v_e((string)$row['tipo']); ?></td>
                            <td><?php echo v_e((string)$row['item_id']); ?></td>
                            <td><?php echo v_e((string)$row['nombre']); ?></td>
                            <td><?php echo v_e((string)$row['cantidad']); ?></td>
                            <td><?php echo v_e((string)$row['stock_minimo']); ?></td>
                            <td><?php echo v_e((string)($row['proveedor'] ?? '')); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_eficiencia as $row): ?>
                        <tr>
                            <td><?php echo v_e((string)($row['artesano'] ?? '')); ?></td>
                            <td><?php echo v_e((string)$row['piezas']); ?></td>
                            <td><?php echo v_e((string)$row['horas']); ?></td>
                            <td><?php echo v_e((string)$row['promedio_horas']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_materiales as $row): ?>
                        <tr>
                            <td><?php echo v_e((string)$row['tipo_material']); ?></td>
                            <td><?php echo v_e((string)$row['material_id']); ?></td>
                            <td><?php echo v_e((string)($row['material_nombre'] ?? '')); ?></td>
                            <td><?php echo v_e((string)$row['cantidad_total']); ?></td>
                            <td><?php echo v_e((string)$row['costo_total']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_ventas as $row): ?>
                        ...
                        <tr>
                            <td><?php echo v_e((string) ($row['id'] ?? '')); ?></td>
                            <td><?php echo v_e((string)$row['producto_id']); ?></td>
                            <td><?php echo v_e($fecha); ?></td>
                            <td><?php echo v_e((string)$row['precio_venta']); ?></td>
                            <td><?php echo v_e((string)$row['utilidad']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if ($legacy): ?>
                ...
                <?php else: ?>
                    <?php foreach ($rep_compras as $row): ?>
                        <tr>
                            <td><?php echo v_e((string)$row['tipo_inventario']); ?></td>
                            <td><?php echo v_e((string)$row['cantidad_total']); ?></td>
                            <td><?php echo v_e((string)$row['movimientos']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            <?php endif; ?>
