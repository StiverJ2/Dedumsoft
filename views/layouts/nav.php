...
$cfg_open = in_array($current, ['configuracion.php', 'catalogos.php'], true);
        ...
        <div class="ds-nav">
            ...
            <?php if ($can_config): ?>
                <div class="ds-nav-section">Ajustes</div>
                    ...
                    <a class="ds-nav-link <?php echo dedumsoft_nav_active($current, 'catalogos.php'); ?>" href="catalogos.php">
                        <img class="ds-icon-img" src="assets/icons/fatcow/16/books.png" alt="">
                        Catalogos
                    </a>
            <?php endif; ?>
        </div>
            ...
            <div class="ds-nav">
                ...
                <?php if ($can_config): ?>
                    ...
                    <div id="ds-config" class="collapse ds-submenu <?php echo $cfg_open ? 'show' : ''; ?>">
                            ...
                            <a class="<?php echo dedumsoft_nav_active($current, 'catalogos.php'); ?>" href="catalogos.php">
                                <span class="ds-subicon">&#128218;</span> Catalogos
                            </a>
                    </div>
                <?php endif; ?>
            </div>
